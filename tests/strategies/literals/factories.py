...
encodings_unsupported_code_points = defaultdict(
        set,
        {'ascii': set(range(128, 256)),
         'big5': set(range(128, 256)),
         'big5hkscs': set(range(128, 256)),
         ...
         'cp949': set(range(128, 256)),
         'cp950': set(range(128, 256)),
         'euc_jis_2004': set(range(128, 256)),
         'euc_jisx0213': set(range(128, 256)),
         'euc_jp': set(range(128, 256)),
         'euc_kr': set(range(128, 256)),
         'gb18030': set(range(128, 256)),
         'gb2312': set(range(128, 256)),
         'gbk': set(range(128, 256)),
